    ...
    public class Call
    {
        ...
        public CallState CallCurrentState
        {
            ...
            set
            {
                ...
                Logger.Instance.LogMessage(Logger.LoggerFiles.DuoLogger3, string.Format("Call Current States [{0}] To [{1}]",_callPvState,value),  Logger.LogLevel.Info);
                ChangeUI(value);
            }
        }
        ...
        private void ChangeUI(CallState state)
        {
            ...
            {
                Logger.Instance.LogMessage(Logger.LoggerFiles.DuoLogger3, "Call ChangeUI", exception, Logger.LogLevel.Error);
            }
        }
